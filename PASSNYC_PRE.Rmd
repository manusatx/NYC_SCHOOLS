...
```{r}
library(readr)
SchoolMain_ori <- read.csv("2016 School Explorer_Reduced.csv")
...
LibraryMain <- read.csv("LIBRARY.csv")
...
AfterSchoolPrograms <- read.csv("DOITT_AFTER_SCHOOL_PROGRAM_01_29JUL2009.csv")
...
AffordableHousing <- read.csv("Affordable_Housing.csv")
